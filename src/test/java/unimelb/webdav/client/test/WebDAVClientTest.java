package unimelb.webdav.client.test;
...
import unimelb.webdav.client.WebDAVClient;
import unimelb.webdav.client.WebDAVClientFactory;
...
public class WebDAVClientTest {
    ...
    public void prepare() throws Throwable {
        ...
        destFilePath = "/unimelb-mf-webdav-plugin-test/test-" + System.currentTimeMillis() + ".dat";
    }
