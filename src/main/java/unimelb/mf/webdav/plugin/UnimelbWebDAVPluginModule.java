package unimelb.mf.webdav.plugin;
...
import unimelb.mf.webdav.plugin.services.SvcWebDAVPut;
import unimelb.mf.webdav.plugin.sink.OwnCloudSink;
import unimelb.mf.webdav.plugin.sink.WebDAVSink;

public class UnimelbWebDAVPluginModule implements PluginModule {
    ...
    public UnimelbWebDAVPluginModule() {
